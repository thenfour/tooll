...
namespace Framefield.Core
{
    ...
    public static SharpDX.Direct3D11.Texture2D CreateTexture2DFromBitmap(SharpDX.Direct3D11.Device device, System.Drawing.Bitmap bitmapSource)
    {
      // Allocate DataStream to receive the WIC image pixels
      var bitmapData = bitmapSource.LockBits(new System.Drawing.Rectangle(0, 0, bitmapSource.Width, bitmapSource.Height),
        System.Drawing.Imaging.ImageLockMode.ReadOnly, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
      //int stride = bitmapSource.Size.Width * 4;
      //using (var buffer = new SharpDX.DataStream(bitmapData.Height * bitmapData.Stride, true, true))
      //{
        ...
        }, new SharpDX.DataRectangle(bitmapData.Scan0, bitmapData.Stride));
